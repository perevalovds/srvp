# The following code was adapted from https://github.com/richzhang/PerceptualSimilarity, see the license file in this
# folder.
...
class PerceptualLoss(torch.nn.Module):
    def __init__(self, model_path, model='net-lin', net='alex', colorspace='rgb', spatial=False, use_gpu=False,#True,
